...
describe("parseAudioLevels（音量解析与夹值）", () => {
  ...
  it("非法/缺省字段回退为 1", () => {
    expect(parseAudioLevels(JSON.stringify({ music: "x" }))).toEqual({ music: 1, sfx: 1 });
  });
